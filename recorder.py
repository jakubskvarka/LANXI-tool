...
class Recorder():
    def __init__(self,name_of_file,record_time,sampling_freq,ip_adress,channel, ccld=None,sensitivity=None,polvolt=None ):
...
#         # odtialto mozem zobrat info, kolko channelov mam zapojenzch a tolko sa bude aj plotovat grafov
...
# #################################### TAKTO TO FUNGUJE, potrebne zautomatizovat
#         # print(self.channel_info)
#         # for i,n in enumerate(setup['channels']):
#         #     if self.channel_info[i]['enabled']=='True':
#         #         n['transducer'] = {
#         #             "direction": "",
#         #             "requires200V": 0,
#         #             "requiresCcld": 1,
...
#         #     else:
#         #         n["enabled"]=["False"]
#         #         print(self.channel_info[i]['sensitivity'])
#         #         print(f'channel{i+1} is disabled')
# ######################################
#         print(self.channel_info)
#         #Konfiguracia na zaklade uzivatela pre senzory bez TEDS
#         for i,ch in enumerate(setup['channels']):
...
#                     }
#                 setup['channels'][i]['ccld'] = True
#                 setup['channels'][i]['polvolt'] = 0
#                 setup['channels'][i]['name']=self.channel_info[i]['name']
#             else:
#                 setup['channels'][i]['enabled'] = False
#
